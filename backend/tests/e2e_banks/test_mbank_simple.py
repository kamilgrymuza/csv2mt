...
class TestMBankSimpleE2E:
    ...
    def test_mbank_csv_to_mt940(self, input_csv, expected_mt940, output_mt940):
        """
        Test complete CSV → MT940 conversion pipeline for mBank
        """
        # Step 1: Parse CSV file
        print("\n" + "="*80)
        print("E2E TEST: mBank Simple CSV → MT940")
        print("="*80)
